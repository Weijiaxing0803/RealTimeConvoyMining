...
//            Calculate the adjacent partitions of the current key partition
...
// the merging condition is not met
//                output
                if(!merge){
                    res = new ArrayList<>();
                    objs = new Objects();
...
//    Determine whether the merging conditions are met
